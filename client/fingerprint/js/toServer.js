...
var ip_address = "http://127.0.0.1:9875/";
...
function getResolution() {
    ...
    var res =
        Math.round(fixed_width) +
        "_" +
        Math.round(fixed_height) +
        "_" +
        zoom_level +
        "_" +
        window.screen.width +
...
var Sender = function () {
    ...
    this.toServer = function (WebGL, inc, gpu, hash, id, dataurl) {
        ...
        console.log("hash ", this.postData["gpuImgs"][id]);
    ...
    this.sendData = function () {
        ...
        cvs_test = CanvasTest();
        // console.log("hello", cvs_test);
        this.postData["canvas_test"] = Base64EncodeUrlSafe(
            calcSHA1(cvs_test.substring(22, cvs_test.length))
        ); //remove the leading words

        // console.log("canvas", this.postData["canvas_test"]);
        ...
        // div.innerHTML = this.postData["canvas_test"];
        // document.body.appendChild(div);

        if (!navigator.hardwareConcurrency) this.postData["cpu_cores"] = "-1";
        else this.postData["cpu_cores"] = navigator.hardwareConcurrency;
